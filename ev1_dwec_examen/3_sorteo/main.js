...
let pedirCartones = prompt("Por favor, introduzca el número de cartones que desea (Entre 1 y 10)", parseInt(3));
let numero = Number.pedirCartones;
const comprobarCartones = (numero = undefined) => {
  if(typeof numero !== "number" ){
    return console.log("Dame un número que sea válido");
  } else {
...
comprobarCartones(pedirCartones);
